...
*create a sequence counting by 1's from a to b (in a:b)*
...
*Ctrl+Alt+I*. Then state what each of these
...
#### *Allows you to return (or work with) only portions of a vector.*
...
#### *square brackets allows you to return (or work with) only portions of a vector.*
...
### *The first creates a sequence from -1 to 2 by ones.*
...
*The second does the same. The third creates a sequence from 1 to 2 then
...
This chunk has added an object named `sleep` to the environment.
...
The sleep data set has 62 : 12 rows.
...
*It appears that TotalSleep decreases as BrainWt increases.*
